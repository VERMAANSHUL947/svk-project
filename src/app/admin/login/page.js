            ...
            <div className="admin-right">
                {step === 1 ? (
                        ...
                        <form onSubmit={handleSendOTP}>
                            ...
                            <div className="verify-info-box">
                                ...
                                <div className="info-content">
                                    ...
                                    <p>Your session is secured via one-time passcodes sent to your device.</p>
                                </div>
                            </div>
                        </form>

                        <p className="help-text">
                            New administrator? <a href="/admin/signup" style={{ color: '#2563EB', textDecoration: 'none', fontWeight: '600' }}>Register here</a>
                        </p>
                    ...
                    <div className="login-form-container otp-form-container">
                        ...
                        <p className="form-subtitle">Code sent to your registered device.</p>
